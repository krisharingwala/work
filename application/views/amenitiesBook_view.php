  ...
  <body>
                ...
                <div class="col-lg-8 col-md-12 d-flex justify-content-end">
                  <a href="#" class="btn btn-teal-info btn-with-icon" data-toggle="modal" data-target="#modal" id="add">
                    <div class="ht-35 justify-content-between">
                      ...
                      <span class="pd-15">Add New Meeting</span>
                    </div>
                  </a>
                </div>
            </div>
              ...
              <div class="modal-content tx-size-sm">
                <div class="modal-body tx-center pd-y-20 pd-x-20">
                  ...
                  <div class="pd-x-30 pd-y-10">
                    <h5 class="tx-inverse  mg-b-30 model-title">Add Meeting</h5>
                    <div class="form-group">
                       <input type="text" name="subject" id="subject" class="form-control pd-y-12" placeholder="Enter Subject">
                    </div><!-- form-group -->
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                      <div class="input-group">
                        ...
                        <input type="date" id="date" class="form-control fc-datepicker" >
                      </div>
                    </div><!-- form-group -->
                    <div class="form-group ">
                      <div class="input-group">
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p tx-center">Amenities</th>
                  <th class="wd-25p tx-center">User Name</th>
                  <th class="wd-20p tx-center">Booking date</th>
                  <th class="wd-10p tx-center">Start time</th>
                  <th class="wd-10p tx-center">end time</th>
                  <th class="wd-10p tx-center">Payment status</th>
                  <th class="wd-10p tx-center">Transition Id</th>
                  <th class="wd-10p tx-center">Created At</th>
    ...
    <script>
      ...
      $(document).ready(function(){ 
        $('#add').click(function(){  
           $('#user_form')[0].reset();  
           $('.model-title').text("Book Amenities");  
           $('#action').val("Add");
           $('#op').val("Add");
      });  
       ...
       var dataTable =  $('#datatable1').DataTable({
          "ajax": {
            url : "<?php echo base_url(); ?>amenitiesBook/displayBookAmenities",
            type : 'GET'
            },
          responsive: true,
          language: {
        ...
        $(document).on('submit', '#user_form', function(event){  
           ...
           {  
                $.ajax({  
                     url:"<?php echo base_url() . 'meetings/meeting_action'?>",  
                     method:'POST',  
                     data:{subject:subject,description:description,date:date,time:time,mid:mid,op:op},   
        ...
        $(document).on('click', '.update', function(){  
           ...
           $.ajax({  
                url:"<?php echo base_url(); ?>meetings/fetch_single_meeting",  
                method:"POST",  
                data:{mid:mid},  
                dataType:"json",  
                success:function(data)  
