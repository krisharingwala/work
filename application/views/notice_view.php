                ...
                <div class="col-lg-8 col-md-12 d-flex justify-content-end">
                  <a href="#" class="btn btn-teal-info btn-with-icon" data-toggle="modal" data-target="#modal" id="add">
                    <div class="ht-35 justify-content-between">
                      ...
                      <span class="pd-15">Add New Notice</span>
                    </div>
                  </a>
                </div>
            </div>
              ...
              <div class="modal-content tx-size-sm">
                <div class="modal-body tx-center pd-y-20 pd-x-20">
                  ...
                  <div class="pd-x-30 pd-y-10">
                    <h5 class="tx-inverse  mg-b-30 model-title">Add Notice</h5>
                    <div class="form-group">
                       <input type="text" name="subject" id="subject" class="form-control pd-y-12" placeholder="Enter Subject">
                    </div><!-- form-group -->
                    <div class="form-group ">
                      <input type="text" name="detail" id="detail" class="form-control pd-y-12" placeholder="Enter detail">
                    </div><!-- form-group -->
                    <div class="form-group ">
                      <input type="text" name="committee_id" id="committee_id" class="form-control pd-y-12" placeholder="Enter committee_id">
                    </div><!-- form-group -->
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p tx-center">Subject</th>
                  <th class="wd-25p tx-center">Detail</th>
                  <th class="wd-20p tx-center">Committee name</th>
    ...
    <script>
      ...
      $(document).ready(function(){ 
       ...
       var dataTable =  $('#datatable1').DataTable({
          "ajax": {
            url : "<?php echo base_url(); ?>notice/displayNotice",
            type : 'GET'
            },
          responsive: true,
          language: {
        ...
        $(document).on('submit', '#user_form', function(event){  
           ...
           if(subject != '' && detail != '' && committee_id != '')  
           {  
                $.ajax({  
                     url:"<?php echo base_url() . 'notice/notice_action'?>",  
                     method:'POST',  
                     data:{subject:subject,detail:detail,committee_id:committee_id,nid:nid,op:op},   
       ...
       $(document).on('click', '.update', function(){  
           ...
           $.ajax({  
                url:"<?php echo base_url(); ?>notice/fetch_single_notice",  
                method:"POST",  
                data:{nid:nid},  
                dataType:"json",  
                success:function(data)  
